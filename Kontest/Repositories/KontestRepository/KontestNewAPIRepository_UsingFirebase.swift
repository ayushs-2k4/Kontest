//
//  KontestNewAPIRepository_UsingFirebase.swift
//  Kontest
//
...
final class KontestNewAPIRepository_UsingFirebase: KontestFetcher {
    private let logger = Logger(subsystem: "com.ayushsinghal.Kontest", category: "KontestNewAPIRepository_UsingFirebase")
