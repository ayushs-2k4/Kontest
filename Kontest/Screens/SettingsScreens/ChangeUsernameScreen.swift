...
struct MainChangeUsernameView: View {
    ...
    var body: some View {
        ...
        SettingsTextFieldView(lightModeImage: .leetCodeDarkLogo, darkModeImage: .leetCodeDarkLogo, title: "Enter LeetCode Username", boundryColor: KontestModel.getColorForIdentifier(siteAbbreviation: "LeetCode"), submitLabel: .next, usernameBinding: $leetcodeUsername, focusedField: _focusedField, currentField: .LeetCode, onPressingNext: {})
