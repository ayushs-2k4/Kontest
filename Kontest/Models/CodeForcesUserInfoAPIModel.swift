...
extension CodeForcesUserInfoAPIModel {
    ...
    private static func userInfoResultDTOToUserInfoAPIResultModel(codeForcesUserInfoAPIResultDTO: CodeForcesUserInfoAPIResultDTO) -> CodeForcesUserInfoAPIResultModel {
        return CodeForcesUserInfoAPIResultModel(contribution: codeForcesUserInfoAPIResultDTO.contribution, lastOnlineTimeSeconds: codeForcesUserInfoAPIResultDTO.lastOnlineTimeSeconds, rating: codeForcesUserInfoAPIResultDTO.rating, friendOfCount: codeForcesUserInfoAPIResultDTO.friendOfCount, titlePhoto: codeForcesUserInfoAPIResultDTO.titlePhoto, rank: codeForcesUserInfoAPIResultDTO.rank, handle: codeForcesUserInfoAPIResultDTO.handle, maxRating: codeForcesUserInfoAPIResultDTO.maxRating, avatar: codeForcesUserInfoAPIResultDTO.avatar, registrationTimeSeconds: codeForcesUserInfoAPIResultDTO.registrationTimeSeconds, maxRank: codeForcesUserInfoAPIResultDTO.maxRank)
    }
}
